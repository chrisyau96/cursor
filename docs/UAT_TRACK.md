...
2. I keep `android/` in the repo. Android Studio → **Generate Signed Bundle** copies the current web app into the AAB (Settings shows `63.0.7`, matching Play). `npm install && npm run cap:sync` is optional.
