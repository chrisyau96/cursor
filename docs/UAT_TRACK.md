...
| **Play Internal testing** | You + a few Gmails | `com.dincey.habitjournal` | **Default UAT.** Real Android (notifications, Drive, widgets). Testers opt in. **Public Play users never see this** |
